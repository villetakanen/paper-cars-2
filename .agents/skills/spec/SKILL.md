---
name: spec
description: Write or update an ASDLC living spec (Blueprint + Contract) for a feature. Use when defining requirements, acceptance criteria, or documenting system behavior before implementation.
---
