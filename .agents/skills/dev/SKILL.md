---
name: dev
description: Implement a task against a spec using subagents. Handles research, coding, testing, and verification. Use when implementing features from specs or GitHub issues.
---
